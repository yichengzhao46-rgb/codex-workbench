...
POSITIVE = {
    ...
    "methane": 3, "oxygen": 2, "anoxic": 4, "hypoxic": 4, "methanotroph": 5,
}
NEGATIVE = {
...
def main() -> int:
    ...
    session.headers.update({"User-Agent": "codex-workbench-stage1.5-wave4/0.1", "Accept-Language": "en-US,en;q=0.8"})
    ...
    (scan_dir / "stage1_5_wave4_scan_summary.json").write_text(json.dumps(summary, indent=2, ensure_ascii=False), encoding="utf-8")
